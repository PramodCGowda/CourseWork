...
class GameListPageState extends State<GameListPage> {
  ...
  Future<void> _fetchGames() async {
    ...
    final response = await http.get(Uri.parse('${AppConstants.baseUrl}/games'),
  ...
  Future<void> _startNewGameWithHuman() async {
    ...
    if (selectedShips!.length == 5) {
      final requestBody = {AppConstants.ships: selectedShips};
      final response =
          await http.post(Uri.parse('${AppConstants.baseUrl}/games'),
              headers: {
  ...
  Future<void> _startGameWithAi(String aiType) async {
    ...
    final Uri url = Uri.parse('${AppConstants.baseUrl}/games');
    ...
    return Scaffold(
        ...
        drawer: Drawer(
          ...
          ListTile(
              ...
              title: const Text(AppConstants.newGame),
              onTap: () {
                Navigator.pop(context);
          ...
          ListTile(
              ...
              title: const Text(AppConstants.newGameAI),
              onTap: () {
                Navigator.pop(context);
                showDialog(
                    context: context,
          ...
          ListTile(
              ...
              title: showCompletedGames
                  ? const Text(AppConstants.activeGames)
                  : const Text(AppConstants.completedGames),
              onTap: () {
                Navigator.pop(context);
                      ...
                      : ListTile(
                          ...
                          trailing: Text((game.status == 1
                              ? (game.player1 == username
                                  ? AppConstants.gameWon
                                  : AppConstants.gameLost)
