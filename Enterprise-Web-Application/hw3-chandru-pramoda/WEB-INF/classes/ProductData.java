...
response.setContentType("text/html");			
 ...
 pw.println("<body>");
		...
		pw.print("<td><div id='shop_item'>");
			...
			switch(data.getType()) {
				case "lights":
					imageFolder = "SmartLightings";
					break;
				case "doorlocks":
					imageFolder = "SmartDoorlocks";
					break;
				case "doorbells":
					imageFolder = "SmartDoorbells";
					break;
				case "speaker":
					imageFolder = "SmartSpeakers";
					break;
				case "thermostat":
					imageFolder = "SmartThermostats";
					break;
				case "accessories":
					imageFolder = "Accessories";
					break;
			}
			pw.print("<li id='item'><img src='images/"+imageFolder+"/"+data.getImage()+"' alt='' /></li>");
