...
public class Registration extends HttpServlet {
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		if (request.getSession().getAttribute("usertype") != null && request.getSession().getAttribute("usertype").equals("retailer")) {
			pw.print("<div class='post' style='float: none; width: 100%; margin-top: 20px'>");
		} else {
