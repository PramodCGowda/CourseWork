...
public class AccessoryList extends HttpServlet {
    ...
    /* Accessory Page Displays all the Accessories and their Information in Smart Homes */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/* Checks the SmartDoorbell maker whether it is microsft or sony or nintendo
...
//		String ConsoleName = request.getParameter("console");
        ...
        HashMap<String, SmartDoorbell> allconsoles = new HashMap<String, SmartDoorbell>();


        /* Checks the Tablets type whether it is microsft or sony or nintendo */
        try {
            allconsoles = MySqlDataStoreUtilities.getDoorbells();
        } catch (Exception e) {
        ...
        if (CategoryName.equals("microsoft")) {
            for (Map.Entry<String, SmartDoorbell> entry : allconsoles.entrySet()) {
...
//		SmartDoorbell console = hm.get(ConsoleName);
        ...
        for (Map.Entry<String, SmartDoorbell> entry : hm.entrySet()) {
            SmartDoorbell console = entry.getValue();
