...
public class PrevAccessory extends HttpServlet {
	...
	/* Console Page Displays all the Consoles and their Information in Smart Homes */
	...
	//	int i = 1; int size= hm.size();
		for(Map.Entry<String, SmartDoorbell> entry : hm.entrySet())
		{
			...
			pw.print("<li id='item'><img src='images/consoles/"+doorbell.getImage()+"' alt='' /></li>");
		...
		pw.print("</h2><div class='entry'><table id='bestseller'>");
		SmartDoorbell doorbell = hm.get(ProductName);
		
		int i = 1; int size= hm.size();
		pw.print("<tr>");
		ArrayList<String> arr = new ArrayList<String> ();
		for(Map.Entry<String, String> acc:doorbell.getAccessories().entrySet())
		{
