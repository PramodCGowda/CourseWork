        ...
        if (filters != null && groupBy != true) {
            for (int i = 0; i < filters.length; i++) {
                ...
                switch (filters[i]) {
                    ...
                    case "StoreCity":
                        filterByCity = true;
                        if (!StoreCity.equals("All") && !groupByCity) {
                            query.put("StoreCity", StoreCity);
                        }
                        break;
    ...
    public void constructGroupByContent(AggregationOutput aggregate, PrintWriter pw, String dataGroupBy) {
        ...
        if (dataGroupBy.equals("Detail")) {
            ...
            for (DBObject result : aggregate.results()) {
                ...
                BasicDBList StoreCity = (BasicDBList) bobj.get("StoreCity");
                ...
                while (detailcount < productList.size()) {
                    tableData = "<tr rowspan = \"3\"><td> Product: " + productList.get(detailcount) + "</br>"
                            ...
                            + "StoreCity: " + StoreCity.get(detailcount) + "</br>"
    ...
    public void constructTableContent(DBCursor dbCursor, PrintWriter pw) {
        ...
        while (dbCursor.hasNext()) {
            ...
            tableData = "<tr><td align='center' colspan='2'>Review</td></tr><tr><td>Name: </td><td>" + bobj.getString("productName") + "</td></tr>"
                    + "<tr><td>Type:</td><td>" + bobj.getString("productType") + "</td></tr>"
                    + "<tr><td>Rating:</td><td>" + bobj.getString("reviewRating") + "</td></tr>"
                    + "<tr><td>Price:</td><td>" + bobj.getString("price") + "</td></tr>"
                    + "<tr><td>Retailer ID:</td><td>" + bobj.getString("StoreID") + "</td></tr>"
                    + "<tr><td>Retailer City:</td><td>" + bobj.getString("StoreCity") + "</td></tr>"
                    + "<tr><td>Retailer State:</td><td>" + bobj.getString("StoreState") + "</td></tr>"
                    + "<tr><td>RetailerZipCode:</td><td>" + bobj.getString("StoreZip") + "</td><tr>"
                    + "<tr><td>ProductOnSale:</td><td>" + bobj.getString("ProductOnSale") + "</td></tr>"
                    + "<tr><td>ManufacturerName:</td><td>" + bobj.getString("ManufacturerName") + "</td></tr>"
                    + "<tr><td>ManufacturerRebate:</td><td>" + bobj.getString("ManufacturerRebate") + "</td></tr>"
                    + "<tr><td>UserID:</td><td>" + bobj.getString("UserID") + "</td></tr>"
                    + "<tr><td>UserAge:</td><td>" + bobj.getString("UserAge") + "</td></tr>"
                    + "<tr><td>UserGender:</td><td>" + bobj.getString("UserGender") + "</td></tr>"
                    + "<tr><td>UserOccupation:</td><td>" + bobj.getString("UserOccupation") + "</td></tr>"
