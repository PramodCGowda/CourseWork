...
public class AjaxUtility {
	...
	public static HashMap<String,Product> getData()
	{
		...
		try
		{
			...
			while(rs.next())
			{
				Product p = new Product(rs.getString("productId"),rs.getString("productName"),rs.getDouble("productPrice"),rs.getString("productImage"),rs.getString("productManufacturer"),rs.getString("productCondition"),rs.getString("ProductType"),rs.getDouble("productDiscount"),rs.getInt("productQuantity"));
